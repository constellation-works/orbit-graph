...
//!
//! Every case in `crates/orbit-graph-cli/tests/fixtures/change-explorer/` is
//! built into a real temporary Git repository, opened as a [`Comparison`], and
//! reconciled against that case's `expected.json`.
//!
